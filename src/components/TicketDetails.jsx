    ...
    return (
        <div>
            ...
            <div className="flex flex-col sm:flex-row gap-2 mt-4">
                ...
                <button onClick={nextStep} className='order-1 sm:order-2 flex-1 border border-[#24A0B5] rounded-xl py-3 text-base sm:text-sm md:text-lg text-[#24A0B5] hover:bg-[#24A0B5] hover:text-white transition-all ease-in-out duration-500'>Download Ticket</button>
            </div>
        </div>
    )
}
